...
const Webseries = () => {
  ...
  const filteredWebseries = debouncedSearch
    ? webseriesList.filter(w => w.title.toLowerCase().includes(debouncedSearch.toLowerCase()))
    : webseriesList;
  ...
  return (
    <div className="relative my-40 mb-60 px-6 md:px-16 lg:px-40 xl:px-44 overflow-hidden min-h-[80vh]">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <h1 className="text-lg font-medium animate-slide-in-left heading-hover-cyan">Showing All Webseries</h1>
      ...
      {loading ? (
        ...
        <div className="flex flex-wrap max-sm:justify-center gap-8">
          {filteredWebseries.map((show, index) => (
            <WebseriesCard
              webseries={show}
        ...
        <div className="flex flex-col items-center justify-center h-40">
          <h1 className="text-xl font-semibold text-center text-gray-400">No webseries found for "{debouncedSearch}"</h1>
        </div>
      ) : (
        <div className="flex flex-col items-center justify-center h-40">

...
const AddMovies = () => {
  return (
    <div>
        <h1 className='text-2xl lg:text-3xl pt-10 pb-2 text-center font-bold'>Add Movies</h1>
        <form className='mx-20 md:mx-40 lg:mx-60 xl:mx-80 border border-[#37C6CB] rounded-lg p-6 flex flex-col items-center justify-center gap-3 lg:gap-4'>
            <label className='lg:text-xl'>Movie Details : </label>
            ...
            <input className='border lg:text-lg px-1 py-1' type="text" placeholder="Movie Title" />
            ...
            <input className='border lg:text-lg px-1 py-1' type="text" placeholder="Runtime" />
